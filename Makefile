...
BUILD_DIR := build
NATIVE_OBJECTS := \
	$(BUILD_DIR)/socket_compat.o \
	$(BUILD_DIR)/process_compat.o
...
$(BUILD_DIR)/socket_compat.o: native/socket_compat.c | $(BUILD_DIR)
	$(CC) $(CFLAGS) -c $< -o $@

$(BUILD_DIR)/process_compat.o: native/process_compat.c | $(BUILD_DIR)
	$(CC) $(CFLAGS) -c $< -o $@
